 ...
 * A distortion and filter object for pure data <br>
 * <br>
 ...
 * @brief Calculates the filtered and distorted output vector<br>
 * @param w A pointer to the object, input and output vectors. <br>
 * For more information please refer to the Pure Data Docs <br>
 * The function calls the lfs_dist_dsp_perform method. <br>
 * @return A pointer to the signal chain right behind the rtap_distortion9000_tilde object. <br>
 */
 ...
 * @brief Adds rtap_distortion9000_tilde_perform to the signal chain. <br>
 * @param x A pointer the lrtap_distortion9000_tilde object <br>
 ...
 * @param x A pointer the rtap_distortion9000_tilde object <br>
 * For more information please refer to the <a href = "https://github.com/pure-data/externals-howto" > Pure Data Docs </a> <br>
 */
 ...
 * @brief Creates a new rtap_distortion9000_tilde object.<br>
 * @param mix Sets the initial dry/wet value. <br>
 * @param distortionMod Sets the initial algorithm. <br>
 * @param saturation Sets the initial saturation value. <br>
 * For more information please refer to the <a href = "https://github.com/pure-data/externals-howto" > Pure Data Docs </a> <br>
 */
 ...
 * @param mix Sets the mix parameter <br>
 * For more information please refer to the <a href = "https://github.com/pure-data/externals-howto" > Pure Data Docs </a> <br>
 */
 ...
 * @brief Sets the gain parameter of the bandpass filter. <br>
 * @param x A pointer the lfs_dist_dsp_tilde object <br>
 * @param gain Sets the gain of the bandpass filter <br>
 */
