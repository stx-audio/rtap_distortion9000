...
void *power_distortion_9000_tilde_new(t_floatarg makeUpLevel, t_floatarg clippingLevel)
{
...
void power_distortion_9000_tilde_setMakeUpLevel(power_distortion_9000_tilde *x, float makeUpLevel)
{
...
void power_distortion_9000_tilde_setClippingLevel(power_distortion_9000_tilde *x, float clippingLevel)
{
...
{
      power_distortion_9000_tilde_class = class_new(gensym("power_distortion_9000~"), (t_newmethod)power_distortion_9000_tilde_new, (t_method)power_distortion_9000_tilde_free,
                                            sizeof(power_distortion_9000_tilde), CLASS_DEFAULT, A_DEFFLOAT, A_DEFFLOAT, 0);

      class_addmethod(power_distortion_9000_tilde_class, (t_method)power_distortion_9000_tilde_dsp, gensym("dsp"), 0);
      class_addmethod(power_distortion_9000_tilde_class, (t_method)power_distortion_9000_tilde_setMakeUpLevel, gensym("makeuplevel"), A_DEFFLOAT, 0);
      class_addmethod(power_distortion_9000_tilde_class, (t_method)power_distortion_9000_tilde_setClippingLevel, gensym("clippinglevel"), A_DEFFLOAT, 0);
